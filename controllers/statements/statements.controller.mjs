...
export const getStatementsAndDetails = async (req, res) => {
    ...
    GROUP_CONCAT(
        ...
        CONCAT(
            ...
            '"statement_content": "', REPLACE(s.content, '"', '\\"'), '", ',
    ...
    SELECT q.statement_id,
           ...
           GROUP_CONCAT(
               ...
               CONCAT(
                   ...
                   '"question_to_statement_id": ', q.statement_id, ', ',

                   '"question_content": "', REPLACE(q.content, '"', '\\"'), '", ',

                   '"answers": [', IFNULL(a.answers, ''), ']',
        ...
        SELECT a.question_id,
               ...
               GROUP_CONCAT(
                   ...
                   CONCAT(
                       ...
                       '"answer_to_question_id": ', a.question_id, ', ',

                       '"answer_content": "', REPLACE(a.content, '"', '\\"'), '", ',
